...
public class Robozin extends AdvancedRobot {
    ...
    public void run() {
       			setBodyColor(new Color(69, 55, 13));
				setGunColor(new Color(69, 55, 13));
				setRadarColor(new Color(69, 55, 13));
				setBulletColor(new Color(69, 55, 13));
				setScanColor(new Color(69, 55, 13));
