...
public class Asmondam extends AdvancedRobot {

    boolean movingForward = true;

    public void run() {
       			setBodyColor(new Color(255, 2255, 222));
				setGunColor(new Color(255, 2255, 222));
				setRadarColor(new Color(255, 2255, 222));
				setBulletColor(new Color(255, 2255, 222));
				setScanColor(new Color(255, 2255, 222));
				
		 setAdjustGunForRobotTurn(true);
        setAdjustRadarForGunTurn(true);

        while (true) {
            setTurnRadarRight(360); // Gira o radar constantemente
            if (movingForward) {
                setAhead(200);
            } else {
                setBack(200);
    ...
    public void onScannedRobot(ScannedRobotEvent event) {
        ...
        // Mira na direção do inimigo
        setTurnGunRight(bearing…
[08:48, 16/09/2023] marcelo: import robocode.*;
