...
public class Jubileu2.0 extends AdvancedRobot {

    boolean movingForward = true;

    public void run() {
       			setBodyColor(new Color(205, 5, 2));
				setGunColor(new Color(55, 55, 222));
				setRadarColor(new Color(5, 22, 2));
				setBulletColor(new Color(55, 25, 2));
				setScanColor(new Color(2, 2, 2));
